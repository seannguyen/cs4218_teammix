...
public class ParserFunctionalTest {
	...
	//base command
	@Test
	public void normalNoQuoteSingleArg() throws ShellException, AbstractApplicationException {
		...
		SequenceCommand actualCmd = (SequenceCommand) parser.parseCommandLine(cmdLine);
		
		compareCommands(expectedCmd, actualCmd);
	}
	
	@Test
	public void normalNoQuote2Arg() throws ShellException, AbstractApplicationException {
	...
	@Test
	public void normalNoQuoteNoArg() throws ShellException, AbstractApplicationException {
		String cmdLine = "app";
		String appName = "app";
		Vector<String> args = new Vector<String>();
	...
	//single quotes
	@Test
	public void singleQuote() throws ShellException, AbstractApplicationException {
		String cmdLine = "app 'arg'";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("arg");
	...
	@Test
	public void singleQuoteContainDoubleQuote() throws ShellException, AbstractApplicationException {
	...
	@Test
	public void singleQuoteContainSingleQuote() throws ShellException, AbstractApplicationException {
		String cmdLine = "app 'a'bc''";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("abc");
	...
	@Test
	public void singleQuoteContainBackQuote() throws ShellException, AbstractApplicationException {
		String cmdLine = "app 'a`bc`'";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("a`bc`");
	...
	@Test
	public void singleQuoteAfterText() throws ShellException, AbstractApplicationException {
	...
	@Test
	public void singleQuoteBeforeText() throws ShellException, AbstractApplicationException {
		String cmdLine = "app 'a'bc";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("abc");
	...
	@Test
	public void singleQuoteMany() throws ShellException, AbstractApplicationException {
	...
	//double quotes
	@Test
	public void doubleQuote() throws ShellException, AbstractApplicationException {
		String cmdLine = "app \"arg\"";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("arg");
	...
	@Test
	public void doubleQuoteContainSingleQuote() throws ShellException, AbstractApplicationException {
		String cmdLine = "app \"a'bc'\"";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("a'bc'");
	...
	public void doubleQuoteContainDoubleQuote() throws ShellException, AbstractApplicationException {
		String cmdLine = "app \"a\"bc\"\"";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("abc");
	...
	public void doubleQuoteContainBackQuote() throws ShellException, AbstractApplicationException {
	...
	public void doubleQuoteAfterText() throws ShellException, AbstractApplicationException {
		String cmdLine = "app ab\"c\"";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("abc");
	...
	public void doubleQuoteBeforeText() throws ShellException, AbstractApplicationException {
		String cmdLine = "app \"a\"bc";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("abc");
	...
	public void doubleQuoteMany() throws ShellException, AbstractApplicationException {
		String cmdLine = "app \"a\" \"b\" \"c\"";
		String appName = "app";
		Vector<String> args = new Vector<String>();
		args.add("a");
	...
	@Test
	public void backQuoteInDoubleQuote() throws ShellException, AbstractApplicationException {
	...
	@Test
	public void backQuoteAfterText() throws ShellException, AbstractApplicationException {
	...
	@Test
	public void backQuoteBeforeText() throws ShellException, AbstractApplicationException {
	...
	@Test
	public void backQuoteMany() throws ShellException, AbstractApplicationException {
	...
	@Test
	public void backQuoteManyInDoubleQuote() throws ShellException, AbstractApplicationException {
	...
	private SequenceCommand buildSeqCommand(String appName, Vector<String> args, String outputFile, String inputFile) {
		SequenceCommand seqCmd = new SequenceCommand();
		PipeCommand pipeCmd = new PipeCommand();
		seqCmd.addCommand(pipeCmd);
		CallCommand callCmd = new CallCommand(appName, inputFile, outputFile, args);
