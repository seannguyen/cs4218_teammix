...
public class SedCommand implements Application {
	...
	public void run(String[] args, InputStream stdin, OutputStream stdout)
		...
		if (args == null || args.length == 0) {
			...
			if (doesFileExist(file)) {
				...
				throw new SedException(" " + fileName + ":" + " Is a directory");
			} else {
				throw new SedException(" " + fileName + ":" + " Does not exist");
			}
	 ...
	 * @throws SedException
	 */
	private void processSed(OutputStream stdout, File file, String replacement) throws SedException {
	 ...
	 * @throws SedException
	 */
	public void processInputStream(InputStream stdin, OutputStream stdout, String replacement)
			throws SedException {
